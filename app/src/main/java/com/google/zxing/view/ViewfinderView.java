...
public final class ViewfinderView extends View {
  ...
  public void onDraw(Canvas canvas) {
    ...
    // Draw the exterior (i.e. outside the framing rect) darkened  绘制聚焦框外的暗色透明层
    drawExterior(canvas, frame, width, height);


    if (resultBitmap != null) {
      // Draw the opaque result bitmap over the scanning rectangle  如果扫描结果不为空，则把扫描的结果填充到聚焦框中
