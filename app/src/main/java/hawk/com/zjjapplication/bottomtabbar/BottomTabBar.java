package hawk.com.zjjapplication.bottomtabbar;
...
import hawk.com.zjjapplication.bottomtabbar.custom.CustomFragmentTabHost;
import hawk.com.zjjapplication.bottomtabbar.util.TintUtil;
...
public class BottomTabBar extends LinearLayout {
    ...
    public BottomTabBar init(FragmentManager manager) {
        mLayout = (LinearLayout) LayoutInflater.from(context).inflate(R.layout.title_bottom_tab_bar_fsc, null);
